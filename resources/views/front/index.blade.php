...
<body id="page-top" data-spy="scroll" data-target=".navbar">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="widget m30">
                                    ...
                                    <div class="widget_body"><img class="img-responsive left" src="{{asset('public/front/assets/img/editor.jpg')}}" alt="Generic placeholder image">
                                ...
                                <div class="widget m30">
                                    ...
                                    <div class="widget_body"><img class="img-responsive left" src="{{asset('public/front/assets/img/reader.jpg')}}" alt="Generic placeholder image">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="media">
                                    <div class="media-left">
                                        <a href="#"><img class="media-object" src="{{asset('public/front/assets/img/editor_pic1.jpg')}}" alt="Generic placeholder image"></a>
                                    </div>
                                    <div class="media-body">
                                        <h3 class="media-heading">
                                ...
                                <div class="media">
                                    <div class="media-left">
                                        <a href="#"><img class="media-object" src="{{asset('public/front/assets/img/editor_pic2.jpg')}}" alt="Generic placeholder image"></a>
                                    </div>
                                    <div class="media-body">
                                        <h3 class="media-heading">
                                            <a href="single.html">Apple launches photo-centric wrist watch for Android</a>
                                ...
                                <div class="media">
                                    <div class="media-left">
                                        <a href="#"><img class="media-object" src="{{asset('public/front/assets/img/editor_pic3.jpg')}}" alt="Generic placeholder image"></a>
                                    </div>
                                    <div class="media-body">
                                        <h3 class="media-heading">
                                            <a href="single.html">Apple launches photo-centric wrist watch for Android</a>
    ...
    <!-- jquery Core-->
    <script src="{{asset('public/front/assets/js/jquery-2.1.4.min.js')}}">
    </script>
